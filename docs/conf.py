# -*- coding: utf-8 -*-
#
# TVDCondat2013 documentation build configuration file, created by
...
project = u'TVDCondat2013'
copyright = u'2016, Boris Gailleton'
...
htmlhelp_basename = 'TVDCondat2013doc'
...
latex_documents = [
    (master_doc, 'TVDCondat2013.tex', u'TVDCondat2013 Documentation',
...
man_pages = [
    (master_doc, 'TVDCondat2013', u'TVDCondat2013 Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TVDCondat2013', u'TVDCondat2013 Documentation',
     author, 'TVDCondat2013', 'One line description of project.',
     'Miscellaneous'),
]
